---
title: "Analysis CLL Proteomics - Final data Limma Proteomics"
author: "Sophie Rabe"
output:
  html_document:
    code_folding: hide
...
## Functions
### Function with DEQMS
```{r limma other mutations function DEQMS, include=TRUE, results="markup", dev=c("png","pdf")}
...
### Annotation function
```{r limma annotation hits other mut function, eval=TRUE, echo=TRUE, cache=TRUE, dev=c("png","pdf")}
...
### Conduct limma
```{r limma other mutations, include=TRUE, results="markup", cache=TRUE, dev=c("png","pdf"), message=FALSE}
limma_results <- NULL
...
### Plot limma results
```{r limma plot other mut, dependson="limma other mutations", eval=TRUE, echo=TRUE, fig.show="asis", cache=TRUE, dev=c("png","pdf")}
...
#### Annotate
```{r limma annotation hits other mut conduct, dependson="limma annotation hits other mut function", eval=TRUE, echo=TRUE, cache=TRUE, dev=c("png","pdf")}
...
### All conditions
```{r limma plot vulcano plot other mut, fig.height=30, fig.width=12, dependson="limma annotation hits other mut conduct", eval=TRUE, echo=TRUE, fig.show="asis", cache=TRUE, dev=c("png","pdf")}
...
```{r limma plot volcano plot other mut tris12, dependson="limma plot vulcano plot other mut", eval=TRUE, echo=TRUE, warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
```{r limma plot volcano plot other mut del13q14, eval=TRUE, echo=TRUE,  dependson="limma plot volcano plot other mut tris12", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
```{r limma plot volcano plot other mut del11q, eval=TRUE, echo=TRUE, dependson="limma plot volcano plot other mut del13q14", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
```{r limma plot volcano plot other mut del17p13, eval=TRUE, echo=TRUE,  dependson="limma plot volcano plot other mut del11q", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
### XPO1
```{r limma plot volcano plot other mut XPO1, eval=TRUE, echo=TRUE,  dependson="limma annotation hits other mut conduct", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
### TP53
```{r limma plot volcano plot other mut TP53, eval=TRUE, echo=TRUE,  dependson="limma annotation hits other mut conduct", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
### ATM
```{r limma plot volcano plot other mut ATM, eval=TRUE, echo=TRUE,  dependson="limma annotation hits other mut conduct", warning=FALSE, cache=TRUE, dev=c("png","pdf")}
...
```{r limma subsets pats CCP all, cache=TRUE, dev=c("png","pdf")}
