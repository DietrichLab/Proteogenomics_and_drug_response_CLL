# adapted from https://github.com/aleferna/BCLandscape/blob/df1a775cbe10770e7903eca47fe5ba5120316457/Generate_Clustering_and_Network.R#L23
# Johansson et al., 2019
detectHighVarianceProteins <- function (expressions,
                                        nCores = 2,
                                        maxit = 1000,
